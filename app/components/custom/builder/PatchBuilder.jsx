...
export function PatchBuilder({ product, config, ...props }) {
  ...
  return (
    <>
      <Visualizer formData={formData} methods={methods} className="" />
      ...
      >
        <section className="flex flex-col w-full max-w-[33rem] gap-6 p-7 lg:pb-0
            md:mx-auto md:px-0
            lg:">
          <PatchHeading formData={formData} methods={methods}/>
          <Form methods={methods} formData={formData} setFormData={setFormData} data={data} config={config} product={product} />
